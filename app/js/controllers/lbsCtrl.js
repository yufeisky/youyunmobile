...
appController.controller('lbsCtrl', ['$scope', '$rootScope', '$state', '$stateParams', '$ionicLoading', '$ionicScrollDelegate', '$ionicModal', '$ionicHistory', '$timeout', '$ionicNavBarDelegate', '$filter', '$compile', 'localStorageService', 'ShareService', 'IonicService', 'Con', 'Tool', function($scope, $rootScope, $state, $stateParams, $ionicLoading, $ionicScrollDelegate, $ionicModal, $ionicHistory, $timeout, $ionicNavBarDelegate, $filter, $compile, localStorageService, ShareService, IonicService, Con, Tool) {
    ...
    // 切换按钮
    $scope.activeTit = '全部';
    $scope.dropDownArr = [{ name: '全部', icon: '', active: true, lbsIconUrl: 'img/point@2x.png' }, { name: '展览聚会', icon: 'icon-upalapp-huodong-off', active: false, lbsIconUrl: 'img/point@2x.png' }, { name: '八卦贴士', icon: 'icon-upalapp-shijian-off', active: false, lbsIconUrl: 'img/point@2x.png' }, { name: '文艺青年', icon: 'icon-upalapp-zhekou-off', active: false, lbsIconUrl: 'img/point@2x.png' }, { name: '说走就走', icon: 'icon-upalapp-wenqing-off', active: false, lbsIconUrl: 'img/point@2x.png' }, { name: '都市传说', icon: 'icon-upalapp-zhuoyou-off', active: false, lbsIconUrl: 'img/point@2x.png' }, { name: '爱蒲天光', icon: 'icon-upalapp-zhuoyou-off', active: false, lbsIconUrl: 'img/point@2x' }, { name: '宠物世界', icon: 'icon-upalapp-zhuoyou-off', active: false, lbsIconUrl: 'img/point@2x' }, { name: '日常便民', icon: 'icon-upalapp-zhuoyou-off', active: false, lbsIconUrl: 'img/point@2x' }];
    $scope.visible = false;
